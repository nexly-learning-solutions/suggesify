...
#define D(x) suggestify::layers::DebugTensor(x, #x)
#define Db(x, bufferManager) suggestify::layers::DebugTensor(x, #x, bufferManager, nullptr)
#define Ds(x, stream) suggestify::layers::DebugTensor(x, #x, nullptr, stream)
