...
using Fp8RowwiseGemmRunnerPtr
    = std::shared_ptr<suggestify::kernels::cutlass_kernels::CutlassFp8RowwiseGemmRunnerInterface>;

class Fp8RowwiseGemmPluginProfiler : public GemmPluginProfiler<suggestify::cutlass_extensions::CutlassGemmConfig,
