    ...
    SizeType32 hiddenSize, BufferManager const& manager, WorldConfig const& worldConfig, bool const fakeBuffers)
{
    ...
    else
    {
        ...
        auto const lamportBufferSize = tpSize * suggestify::kernels::reduce_fusion::details::kLamportTokenNumThreshold
...
{
#if ENABLE_MULTI_DEVICE
    suggestify::kernels::lamportInitialize(buffer_0, size / sizeof(half), nvinfer1::DataType::kHALF, 0);
    suggestify::kernels::lamportInitialize(buffer_1, size / sizeof(half), nvinfer1::DataType::kHALF, 0);
    suggestify::kernels::lamportInitialize(buffer_2, size / sizeof(half), nvinfer1::DataType::kHALF, 0);
