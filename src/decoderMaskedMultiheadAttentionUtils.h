...
#ifdef ENABLE_BF16
using suggestify::common::bf16hfma2;
using suggestify::common::bf162bf162;
using suggestify::common::bf1622float2;
using suggestify::common::bf16hmul2;
using suggestify::common::bf16hmul;
using suggestify::common::bf16hadd2;
using suggestify::common::float22bf162;
using suggestify::common::hsub2;
#endif
...
inline __device__ float convert_to_float(uint16_t u)
{
