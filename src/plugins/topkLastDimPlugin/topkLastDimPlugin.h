...
{
public:
    TopkLastDimPlugin(nvinfer1::DataType type, int32_t k, bool largest);
    TopkLastDimPlugin(void const* data, size_t length);
...
class TopkLastDimPluginCreator : public BaseCreator
{
public:
