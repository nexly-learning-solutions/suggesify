...
{
    dim3 grid(int(suggestify::common::divUp(params.max_input_seq_len, 32)), params.batch_size, params.head_num + 8);
...
{
    dim3 grid(int(suggestify::common::divUp(params.acc_q_len, 32)), params.head_num + 1 + 8);
    auto head_size = params.meta.qk_nope_head_dim;
