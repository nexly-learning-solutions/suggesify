...
{
// Must be similar to [cpp/../thop/gatherTreeOp.cpp] gatherTree
    ...
    SamplingConfig const& samplingConfig)
{
    ...
    suggestify::kernels::invokeInitializeOutput(bufferCast<TokenIdType>(finalOutputIds),
    ...
    suggestify::kernels::BeamHypotheses bh;
    ...
    bh.finished = bufferCast<suggestify::kernels::FinishedState>(*decodingOutput.finishReasons);
    ...
    suggestify::kernels::invokeInsertUnfinishedPath(bh, stream);
    sync_check_cuda_error();
