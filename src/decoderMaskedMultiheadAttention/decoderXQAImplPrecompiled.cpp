...
public:
    ...
    {
        int device_id = suggestify::common::getDevice();
...
{
    XQAKernelList const* xqa_kernel = getXQAKernels(mRunner->mDataType, suggestify::common::getSMVersion());
...
bool DecoderXQAImplPrecompiled::shouldUse(XQAParams const& xqaParams, bool forConfigurePlugin)
{
    ...
    if (xqaParams.mask_type != suggestify::kernels::AttentionMaskType::CAUSAL)
    {
